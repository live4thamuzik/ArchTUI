    ...
    pub fn get_predefined_options(field_name: &str) -> Vec<String> {
        match field_name {
            ...
            "Locale" => vec![
                ...
                "en_AU.UTF-8".to_string(),
                "en_CA.UTF-8".to_string(),
                "en_IN.UTF-8".to_string(),
                "en_NZ.UTF-8".to_string(),
                ...
                "nb_NO.UTF-8".to_string(),
                "da_DK.UTF-8".to_string(),
                "fi_FI.UTF-8".to_string(),
                "pl_PL.UTF-8".to_string(),
                "cs_CZ.UTF-8".to_string(),
                "hu_HU.UTF-8".to_string(),
                "ro_RO.UTF-8".to_string(),
                "tr_TR.UTF-8".to_string(),
                "ru_RU.UTF-8".to_string(),
                "uk_UA.UTF-8".to_string(),
                "el_GR.UTF-8".to_string(),
                "ar_SA.UTF-8".to_string(),
                "ja_JP.UTF-8".to_string(),
                "zh_CN.UTF-8".to_string(),
                "ko_KR.UTF-8".to_string(),
                "th_TH.UTF-8".to_string(),
                "vi_VN.UTF-8".to_string(),
            ],
            "Keymap" => vec![
                "us".to_string(),
                "uk".to_string(),
