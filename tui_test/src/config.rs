...
pub struct ConfigOption {
    ...
    /// Available choices for selection-type options (empty for free-text)
    #[serde(default)]
...
impl ConfigOption {
    ...
    /// Builder: attach available choices for a selection-type option
        ...
        Self {
            options: vec![
                ...
                ConfigOption::new("Boot Mode", true, "Boot firmware type (Auto/UEFI/BIOS)", "")
                    .with_options(vec!["Auto", "UEFI", "BIOS"]),
                ConfigOption::new(
                    "Secure Boot",
                    false,
                ...
                ConfigOption::new("Root Filesystem", true, "Root partition filesystem", "ext4")
                    .with_options(vec!["ext4", "xfs", "btrfs"]),
                ConfigOption::new(
                ...
                ConfigOption::new("Swap Size", false, "Swap partition size", "N/A")
                    .with_options(vec!["2GB", "4GB", "8GB", "Equal to RAM", "Double RAM"]),
                ...
                ConfigOption::new(
                    ...
                    "weekly",
                ).with_options(vec!["hourly", "daily", "weekly", "monthly"]),
                ConfigOption::new(
                    "Btrfs Keep Count",
                    false,
                    "Number of snapshots to keep",
                    "3",
                ).with_options(vec!["1", "3", "5", "10", "20"]),
                ...
                ConfigOption::new("Kernel", true, "Linux kernel to install", "linux")
                    .with_options(vec!["linux", "linux-lts", "linux-zen", "linux-hardened"]),
                ...
                ConfigOption::new("GPU Drivers", false, "Graphics drivers", "Auto")
                    .with_options(vec!["Auto", "Nvidia", "NvidiaOpen", "AMD", "Intel", "Nouveau", "None"]),
                // Hostname (27)
                ...
                ConfigOption::new("AUR Helper", false, "AUR package helper", "none")
                    .with_options(vec!["none", "paru", "yay", "pikaur"]),
                ...
                ConfigOption::new("Bootloader", true, "Boot loader", "grub")
                    .with_options(vec!["grub", "systemd-boot"]),
